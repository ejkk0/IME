...
#SBATCH --job-name=count_pentamers
#SBATCH --output=/scratch/users/ejkk/Cluster/IME/nsIME_screen/count_pentamers.out
#SBATCH -N 1
#SBATCH -n 1
#SBATCH --mem=128000
...
printf('generating pentamer tables...')
...
with open(outpath+'ns_pentamer_counts.pkl','wb') as f:
